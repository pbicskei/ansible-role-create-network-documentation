...
try:
    ...
    raise AnsibleError("[ create-network-documentation_command ]: Dependency not satisfied")
...
def main():
    """
        Examples:
            ...
            https://github.com/ansible/ansible/blob/devel/lib/ansible/modules/network/junos/junos_command.py
    """
    raise AnsibleError(" [ create-network-documentation_command ]: Not Implemented")
