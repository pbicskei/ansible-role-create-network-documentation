...
try:
    ...
    raise AnsibleError("Netconf Plugin [ create-network-documentation ]: Dependency not satisfied")
...
class Netconf(NetconfBase):
    """
        Examples:
            ...
            https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/netconf/junos.py
    """
    raise AnsibleError("Netconf Plugin [ create-network-documentation ]: Not implemented")
